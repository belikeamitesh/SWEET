...
function Social() {
    ...
    <div className={styles.container}>
        ...
        {showSMSInformation? <div className={styles.SMSZone}>
            {showSMSInformation? <h2>Please write the phone number you are trying to join:</h2>: null}<br/>
        ...
        <div className={styles.flexContainer}>
            ...
            {showSMSInformation? <button className={styles.button} onClick={()=>setVisibleSMSInformation(false)}>Hide Text Message Sender</button>: null}
